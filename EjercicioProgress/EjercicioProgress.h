...
protected:
	...
	void InitializeGui()
	{
		...
		btBajar.Create(NULL, L"Bajar", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 441, 45, 123, 28, hWnd, 1001);
		tank1.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_VISIBLE, 31, 14, 382, 194, hWnd, 1002);
		fontArial014A.Create(L"Arial", 14, false, false, false, false);
		btSubir.Font = fontArial014A;
		btBajar.Font = fontArial014A;
		tank1.Font = fontArial014A;
	}
	//_________________________________________________
	void btSubir_Click(Win::Event& e);
	void btBajar_Click(Win::Event& e);
	...
	bool EventHandler(Win::Event& e)
	{
		...
		if (btBajar.IsEvent(e, BN_CLICKED)) { btBajar_Click(e); return true; }
		return false;
	}
};
